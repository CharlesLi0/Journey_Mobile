...
public class Test_Id10_Pbi13 extends UiAutomatorTestCase {
    ...
    public void test_bbq() throws UiObjectNotFoundException {
        ...
        sleep(2000);
        new UiObject(new UiSelector().resourceId("com.example.journeyMobile:id/bbq_bt")).clickAndWaitForNewWindow();
        sleep(1000);
        new UiObject(new UiSelector().className("android.view.View").index(1)).clickAndWaitForNewWindow();
        expectedResult = "bbq2";
        actualResult = new UiObject(new UiSelector().text("bbq2")).getText();
