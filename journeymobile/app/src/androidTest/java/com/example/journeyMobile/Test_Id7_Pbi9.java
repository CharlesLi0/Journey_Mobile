...
step1:
open app and click "map" button
step2:
browse the google map page
*
*
*
*
...
public class Test_Id7_Pbi9 extends UiAutomatorTestCase {
    ...
    public void test_map() throws UiObjectNotFoundException {
